const discoverData = [
    ...
    {
        id: 'discover-2',
        title: 'Hiking the Gran Canyon',
        location: 'USA',
        image: require('../images/canyon.png'),
        imageBig: require('../images/canyon-big.png'),
        description:
            "Great day hikes and backpacking routes on the North and South Rim of this century-old national park include easy hikes overlooking the rim more rugged trekking options that descend into the canyon.",
        liked: true,
        price: 350,
        rating: 4.5,
        duration: 3,
